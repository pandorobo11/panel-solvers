...
class Phase5bShieldingGoldenTests(unittest.TestCase):
    def test_both_models_and_ray_backends_match_exact_shield_masks(self) -> None:
        ...
        for solver, prefix in (
            ...
            for backend in ("rtree", "embree"):
                ...
                case_path = GOLDEN_ROOT / solver / f"{prefix}_shield_{backend}.json"
                ...
                with self.subTest(solver=solver, backend=backend):
