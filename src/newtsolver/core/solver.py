"""Frozen newtsolver direct solver API over the shared Phase 7 runtime."""
...
_RENAMES = {"out_attitude_input": "attitude_input"}


def _build_execution_order(df: pd.DataFrame) -> list[int]:
    return legacy_execution_order(df, strict=False)
